...
namespace Beezy.BackendTest.Infrastructure.CrossCutting.Logging
{
    public class LogContextMiddleware
    {
        ...
        {
            var correlationHeaders = Activity.Current.Baggage.Distinct()
                .ToDictionary(b => b.Key, b => (object)b.Value);
